...
VALUES ('1.0', TIMESTAMP WITH TIME ZONE '2022-06-22T09:00:00.12345Z', TIMESTAMP WITH TIME ZONE
        '2022-07-25T20:50:07.12345Z', 1);

INSERT INTO tb_offer(edition, start_Moment, end_Moment, course_id)
VALUES ('2.0', TIMESTAMP WITH TIME ZONE '2022-12-22T09:00:00.12345Z', TIMESTAMP WITH TIME ZONE
        '2023-12-25T20:50:07.12345Z', 1);
...
VALUES ('Cap 1', 'Vamos começar', 1, 'https://i.ytimg.com/vi/sTX0UEplF54/maxresdefault.jpg', 1, null);

INSERT INTO tb_section(title, description, position, img_Uri, resource_id, prerequisite_id)
VALUES ('Cap 2', 'O que é HTML', 1, 'https://i.ytimg.com/vi/sTX0UEplF54/maxresdefault.jpg', 1, 1);
